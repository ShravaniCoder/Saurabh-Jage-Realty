    ...
    <section>
      ...
      <div className="mx-16 ">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-20 bg-[#F8F8F8]">
          <div className="w-[50%]">
            <Image src={About1} alt="Building" className=" h-[90vh]" />
          </div>
          <div className="w-[50%] ">
            <div className="flex flex-col mx-20 my-10  ">
              ...
              <div>
                ...
                <h1 className="text-2xl uppercase">beautiful of design</h1>
                ...
                <button className="text-[#CABE9F] border-2 border-[#CABE9F]  px-8 py-2">
                  DISCOVER
                </button>
              </div>
            </div>
